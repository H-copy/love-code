...
export { BasePropType, DEFAULT_FOR_VALUE, IS_PROP, IS_TAG, TagType, VPropType, buildPropsByList, dataFormatter, dynamiceTag, getTagName, isDynamicFor, isDynamicProp, isDynamicTag, isDynamicTagType, isEventProp, isForProp, isIfProp, isModelProp, isNativeProp, isNativeTag, isNativeTagType, isProp, isRefProp, isSlefProp, isSlefTag, isSlefTagType, isSlotProp, isTag, isTagType, isTextTag, isTextTagType, mixDefaultForValue, nativeProp, nativeTag, node, parseArray, parseBase, parseObj, prop, propStrinify, propToString, selfProp, selfPropStrinify, selfTag, tagtoString, textTag, vDirective, vDirectiveNameFormatter, vDirectiveProp, vDynamiceProp, vEventProp, vForPropStringify, vIfProp, vModelProp, vRefProp, vRefPropStringify, vSlotProp };
